...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        //Content Day W1D2
        CourseNote what_is_programming = new CourseNote("What is programming", "This will be the content of what is programming", W1D2);
        courseNoteRepository.save(what_is_programming);
        CourseNote control_flow = new CourseNote("Control Flow / Conditionals", "This will be the content of Command Line Basics", W1D2);
        courseNoteRepository.save(control_flow);
        CourseNote lists = new CourseNote("Lists", "This will be the content of Command Line Basics", W1D2);
        courseNoteRepository.save(lists);
        CourseNote dictionaries = new CourseNote("Dictionaries", "This will be the content of Git and Github", W1D2);
        courseNoteRepository.save(dictionaries);
        CourseNote loops = new CourseNote("Loops", "This will be the content of Command Line Basics", W1D2);
        courseNoteRepository.save(loops);
        Lab list_and_dictionaries_lab = new Lab("Lists & Dictionaries", "Extensive Js Lab", W1D2);
        labRepository.save(list_and_dictionaries_lab);

        //Content Day W1D3
        CourseNote functions = new CourseNote("Functions", "This will be the content of what is programming", W1D3);
        courseNoteRepository.save(functions);
        CourseNote unit_tests = new CourseNote("Unit Tests", "This will be the content of Command Line Basics", W1D3);
        courseNoteRepository.save(unit_tests);
        CourseNote intro_to_pair_prog = new CourseNote("Intro to Pair Programming", "This will be the content of Command Line Basics", W1D3);
        courseNoteRepository.save(intro_to_pair_prog);
        Lab functions_1 = new Lab("Functions 1", "Extensive Js Lab", W1D3);
        labRepository.save(functions_1);
        CourseNote loop_to_search_lists = new CourseNote("Loops to Search Lists", "This will be the content of Git and Github", W1D3);
        courseNoteRepository.save(loop_to_search_lists);
        Homework functions_2 = new Homework("Functions 2", "This will be the content of the Github Homework", W1D3);
        homeworkRepository.save(functions_2);

        //Content Day W1D4
        CourseNote modules_and_packages = new CourseNote("Modules and Packages", "This will be the content of what is programming", W1D4);
        courseNoteRepository.save(modules_and_packages);
        Lab friends = new Lab("Friends", "Extensive Js Lab", W1D4);
        labRepository.save(friends);

        //Content Day W1D5
        CourseNote pda_induction = new CourseNote("PDA Induction", "This will be the content of what is programming", W1D5);
        courseNoteRepository.save(pda_induction);
        Homework tdd_pet_shop = new Homework("TDD Petshop", "This will be the content of the Github Homework", W1D5);
        homeworkRepository.save(tdd_pet_shop);
        CourseNote w1d5_recap = new CourseNote("PDA Induction", "This will be the content of what is programming", W1D5);
        courseNoteRepository.save(w1d5_recap);

        //Content Day W2D1
        CourseNote pythonic_loops = new CourseNote("Pythonic Loops", "This will be the content of Command Line Basics", W2D1);
        courseNoteRepository.save(pythonic_loops);
        CourseNote data_structures_101 = new CourseNote("Data Structures 101", "This will be the content of Command Line Basics", W2D1);
        courseNoteRepository.save(data_structures_101);
        Lab functional_python = new Lab("Functional Python", "Extensive Js Lab", W2D1);
        labRepository.save(functional_python);
        Homework python_debugging_techniques = new Homework("Python Debugging Techniques", "This will be the content of the Github Homework", W2D1);
        homeworkRepository.save(python_debugging_techniques);

        //Content Day W2D2
        CourseNote object_orientated_p = new CourseNote("Object-Oriented Programming", "This will be the content of Command Line Basics", W2D2);
        courseNoteRepository.save(object_orientated_p);
        CourseNote file_io_mastery = new CourseNote("File I/O Mastery", "This will be the content of Command Line Basics", W2D2);
        courseNoteRepository.save(file_io_mastery);
        CourseNote advanced_topics_in_python= new CourseNote("Advanced Topics in Python", "This will be the content of Command Line Basics", W2D2);
        courseNoteRepository.save(advanced_topics_in_python);
        Lab web_scraping_with_python = new Lab("Web Scraping with Python", "Extensive Js Lab", W2D2);
        labRepository.save(web_scraping_with_python);

        //Content Day W2D3
        CourseNote data_analysis_with_pandas = new CourseNote("Data Analysis with Pandas", "This will be the content of Command Line Basics", W2D3);
        courseNoteRepository.save(data_analysis_with_pandas);
        CourseNote machine_learning_with_python = new CourseNote("Machine Learning with Python", "This will be the content of Command Line Basics", W2D3);
        courseNoteRepository.save(machine_learning_with_python);
        Lab numpy_array_operations = new Lab("Numpy Array Operations", "Extensive Js Lab", W2D3);
        labRepository.save(numpy_array_operations);
        Homework matplotlib_visualization = new Homework("Matplotlib Visualization", "This will be the content of the Github Homework", W2D3);
        homeworkRepository.save(matplotlib_visualization);

        //Content Day W2D4
        CourseNote text_processing_with_python = new CourseNote("Text Processing with Python", "This will be the content of Command Line Basics", W2D4);
        courseNoteRepository.save(text_processing_with_python);
        CourseNote web_development_with_django = new CourseNote("Web Development with Django", "This will be the content of Command Line Basics", W2D4);
        courseNoteRepository.save(web_development_with_django);
        Lab multithreading_in_python = new Lab("Multithreading in Python", "Extensive Js Lab", W2D4);
        labRepository.save(multithreading_in_python);
        Homework exploring_python_libraries = new Homework("Exploring Python Libraries", "This will be the content of the Github Homework", W2D4);
        homeworkRepository.save(exploring_python_libraries);

        //Content Day W2D5
        CourseNote pda_w2_d5_homework = new CourseNote("PDA W2D5 Homework", "This will be the content of what is programming", W2D5);
        courseNoteRepository.save(pda_w2_d5_homework);
        Homework weekend_flask_homework = new Homework("Weekend Homework - Building REST APIs with Flask", "This will be the content of the Github Homework", W2D5);
        homeworkRepository.save(weekend_flask_homework);
        CourseNote w2d5_recap = new CourseNote("Week 2 Recap", "This will be the content of what is programming", W2D5);
        courseNoteRepository.save(w2d5_recap);

        //Content Day W3D1
        CourseNote realtime_data_streaming = new CourseNote("Real-Time Data Streaming", "This will be the content of Command Line Basics", W3D1);
        courseNoteRepository.save(realtime_data_streaming);
        CourseNote data_wrangling_with_python = new CourseNote("Data Wrangling with Python", "This will be the content of Command Line Basics", W3D1);
        courseNoteRepository.save(data_wrangling_with_python);
        Lab algorithm_design_with_python = new Lab("Algorithm Design with Python", "Extensive Js Lab", W3D1);
        labRepository.save(algorithm_design_with_python);
        Homework automating_tasks_with_python = new Homework("Automating Tasks with Python", "This will be the content of the Github Homework", W3D1);
        homeworkRepository.save(automating_tasks_with_python);

        //Content Day W3D2
        CourseNote big_data_processing_with_pySpark = new CourseNote("Big Data Processing with PySpark", "This will be the content of Command Line Basics", W3D2);
        courseNoteRepository.save(big_data_processing_with_pySpark);
        CourseNote game_development_with_pygame= new CourseNote("Game Development with Pygame", "This will be the content of Command Line Basics", W3D2);
        courseNoteRepository.save(game_development_with_pygame);
        CourseNote working_with_time_series_data = new CourseNote("Working with Time Series Data", "This will be the content of Command Line Basics", W3D2);
        courseNoteRepository.save(working_with_time_series_data);
        CourseNote scipy_for_scientific_computing = new CourseNote("Scipy for Scientific Computing", "This will be the content of Command Line Basics", W3D2);
        courseNoteRepository.save(scipy_for_scientific_computing);
        Lab networking_with_python = new Lab("Networking with Python", "Extensive Js Lab", W3D2);
        labRepository.save(networking_with_python);
        Homework data_exploration_with_python = new Homework("Data Exploration with Python", "This will be the content of the Github Homework", W3D2);
        homeworkRepository.save(data_exploration_with_python);

        //Content Day W3D3
        CourseNote data_cleaning_with_python = new CourseNote("Data Cleaning with Python", "This will be the content of Command Line Basics", W3D3);
        courseNoteRepository.save(data_cleaning_with_python);
        CourseNote machine_learning_algorithms = new CourseNote("Machine Learning Algorithms", "This will be the content of Command Line Basics", W3D3);
        courseNoteRepository.save(machine_learning_algorithms);
        Lab speech_processing_python = new Lab("Speech Processing with Python", "Extensive Js Lab", W3D3);
        labRepository.save(speech_processing_python);
        Homework image_processing_with_python = new Homework("Image Processing with Python", "This will be the content of the Github Homework", W3D3);
        homeworkRepository.save(image_processing_with_python);

        //Content Day W3D4
        CourseNote working_with_csv_files = new CourseNote("Working with CSV Files", "This will be the content of Command Line Basics", W3D4);
        courseNoteRepository.save(working_with_csv_files);
        Lab building_web_crawlers = new Lab("Building Web Crawlers", "Extensive Js Lab", W3D4);
        labRepository.save(building_web_crawlers);
        Homework time_series_analysis_with_python = new Homework("Time Series Analysis with Python", "This will be the content of the Github Homework", W3D4);
        homeworkRepository.save(time_series_analysis_with_python);

        //Content Day W3D5
        Homework weekend_data_homework = new Homework("Weekend Homework - Data Encryption with Python", "This will be the content of the Github Homework", W3D5);
        homeworkRepository.save(weekend_data_homework);
        CourseNote w3d5_recap = new CourseNote("Week 3 Recap", "This will be the content of what is programming", W3D5);
        courseNoteRepository.save(w3d5_recap);

        //Content Day W4D1
        CourseNote data_mining_with_python = new CourseNote("Data Mining with Python", "This will be the content of Command Line Basics", W4D1);
        courseNoteRepository.save(data_mining_with_python);
        CourseNote building_image_classification_models = new CourseNote("Building Image Classification Models", "This will be the content of Command Line Basics", W4D1);
        courseNoteRepository.save(building_image_classification_models);
        CourseNote data_analysis_with_jupyter_notebooks = new CourseNote("Data Analysis with Jupyter Notebooks", "This will be the content of Command Line Basics", W4D1);
        courseNoteRepository.save(data_analysis_with_jupyter_notebooks);
        Lab exploring_unstructured_data_python = new Lab("Exploring Unstructured Data with Python", "Extensive Js Lab", W4D1);
        labRepository.save(exploring_unstructured_data_python);
        Homework building_interactive_maps_with_folium = new Homework("Building Interactive Maps with Folium", "This will be the content of the Github Homework", W4D1);
        homeworkRepository.save(building_interactive_maps_with_folium);

        //Content Day W4D2
        CourseNote data_manipulation_with_python = new CourseNote("Data Manipulation with Python", "This will be the content of Command Line Basics", W4D2);
        courseNoteRepository.save(data_manipulation_with_python);
        CourseNote vr_with_python = new CourseNote("Building Virtual Reality Applications with Python", "This will be the content of Command Line Basics", W4D2);
        courseNoteRepository.save(vr_with_python);
        Lab building_stock_market_analysers = new Lab("Building Stock Market Analyzers", "Extensive Js Lab", W4D2);
        labRepository.save(building_stock_market_analysers);

        //Content Day W4D3
        Lab building_financial_models = new Lab("Building Financial Models with Python", "Extensive Js Lab", W4D3);
        labRepository.save(building_financial_models);
        CourseNote building_social_media_analyzers = new CourseNote("Building Social Media Analyzers", "This will be the content of Command Line Basics", W4D3);
        courseNoteRepository.save(building_social_media_analyzers);
        CourseNote data_transformation_with_pySpark = new CourseNote("Data Transformation with PySpark", "This will be the content of Command Line Basics", W4D3);
        courseNoteRepository.save(data_transformation_with_pySpark);
        Homework data_management_with_python = new Homework("Data Management with Python", "This will be the content of the Github Homework", W4D3);
        homeworkRepository.save(data_management_with_python);

        //Content Day W4D4
        CourseNote python_scripting_for_automation = new CourseNote("Python Scripting for Automation", "This will be the content of Command Line Basics", W4D4);
        courseNoteRepository.save(python_scripting_for_automation);
        Lab data_science_with_python = new Lab("Data Science with Python", "Extensive Js Lab", W4D4);
        labRepository.save(data_science_with_python);
        CourseNote building_chatbots_with_dialogflow = new CourseNote("Building Chatbots with Dialogflow", "This will be the content of Command Line Basics", W4D4);
        courseNoteRepository.save(building_chatbots_with_dialogflow);
        CourseNote data_insights_with_python = new CourseNote("Data Insights with Python", "This will be the content of Command Line Basics", W4D4);
        courseNoteRepository.save(data_insights_with_python);
        Homework python_project_handout = new Homework("Python Project Handout", "This will be the content of the Github Homework", W4D4);
        homeworkRepository.save(python_project_handout);

        //Content Day W4D5
        CourseNote pda_python_project = new CourseNote("PDA Python Project Planning", "This will be the content of what is programming", W4D5);
        courseNoteRepository.save(pda_python_project);
        Homework submit_project_briefs = new Homework("Submit Project Briefs", "This will be the content of the Github Homework", W4D5);
        homeworkRepository.save(submit_project_briefs);
        CourseNote w4d5_recap = new CourseNote("PDA Induction", "This will be the content of what is programming", W4D5);
        courseNoteRepository.save(w4d5_recap);

        //Content Day W5D1
        Homework python_projects = new Homework("Python Projects", "This will be the content of the Github Homework", W5D1);
        ...
        //Content Day W6D1
        CourseNote javascript_basics = new CourseNote("JavaScript Basics", "This will be the content of JavaScript Fundamentals", W6D1);
        courseNoteRepository.save(javascript_basics);
        CourseNote object_oriented_javascript = new CourseNote("Object-Oriented JavaScript", "This will be the content of Advanced JavaScript Techniques", W6D1);
        courseNoteRepository.save(object_oriented_javascript);
        CourseNote functional_javascript = new CourseNote("Functional JavaScript", "This will be the content of Modern JavaScript Practices", W6D1);
        courseNoteRepository.save(functional_javascript);
        Lab manipulating_the_dom = new Lab("Manipulating the DOM with JavaScript", "Extensive JavaScript Lab", W6D1);
        labRepository.save(manipulating_the_dom);
        Homework javascript_events_handling = new Homework("Handling JavaScript Events", "This will be the content of the JavaScript Homework", W6D1);
        homeworkRepository.save(javascript_events_handling);

        //Content Day W6D2
        CourseNote asynchronous_javascript = new CourseNote("Asynchronous JavaScript", "This will be the content of JavaScript Promises and Async/Await", W6D2);
        courseNoteRepository.save(asynchronous_javascript);
        CourseNote building_javascript_applications = new CourseNote("Building JavaScript Applications", "This will be the content of JavaScript Frameworks and Libraries", W6D2);
        courseNoteRepository.save(building_javascript_applications);
        Lab building_javascript_games = new Lab("Building JavaScript Games", "Extensive JavaScript Lab", W6D2);
        labRepository.save(building_javascript_games);

        //Content Day W6D3
        Lab testing_javascript_applications = new Lab("Testing JavaScript Applications", "Extensive JavaScript Lab", W6D3);
        labRepository.save(testing_javascript_applications);
        CourseNote building_javascript_plugins = new CourseNote("Building JavaScript Plugins", "This will be the content of JavaScript Libraries and Plugins", W6D3);
        courseNoteRepository.save(building_javascript_plugins);
        CourseNote javascript_performance_optimization = new CourseNote("JavaScript Performance Optimization", "This will be the content of Advanced JavaScript Techniques", W6D3);
        courseNoteRepository.save(javascript_performance_optimization);
        Homework building_javascript_widgets = new Homework("Building JavaScript Widgets", "This will be the content of the JavaScript Homework", W6D3);
        homeworkRepository.save(building_javascript_widgets);

        //Content Day W6D4
        CourseNote serverless_javascript_architecture = new CourseNote("Serverless JavaScript Architecture", "This will be the content of Serverless JavaScript", W6D4);
        courseNoteRepository.save(serverless_javascript_architecture);
        Lab building_javascript_APIs = new Lab("Building JavaScript APIs", "Extensive JavaScript Lab", W6D4);
        labRepository.save(building_javascript_APIs);
        CourseNote real_time_javascript_applications = new CourseNote("Building Real-time JavaScript Applications", "This will be the content of WebSockets and Real-time Data", W4D4);
        courseNoteRepository.save(real_time_javascript_applications);


        //Content Day W6D5
        CourseNote building_interactive_dashboards = new CourseNote("Building Interactive Dashboards with React and D3", "This will be the content of what is programming", W6D5);
        courseNoteRepository.save(building_interactive_dashboards);
        Homework javaScript_performance_optimizations = new Homework("JavaScript Performance Optimization", "This will be the content of the Github Homework", W6D5);
        homeworkRepository.save(javaScript_performance_optimizations);
        CourseNote w6d5_recap = new CourseNote("Weekly Recap - W6D5", "This will be the content of what is programming", W6D5);
        courseNoteRepository.save(w6d5_recap);


        //Content Day W7D1
        CourseNote dom_manipulation = new CourseNote("DOM Manipulation with JavaScript", "Understand how to manipulate the Document Object Model", W7D1);
        courseNoteRepository.save(dom_manipulation);
        CourseNote js_and_html = new CourseNote("Integrating JavaScript with HTML", "Learn how to add JavaScript to your HTML pages", W7D1);
        courseNoteRepository.save(js_and_html);
        Lab js_functions = new Lab("JavaScript Functions", "Practice using functions in JavaScript", W7D1);
        labRepository.save(js_functions);
        Homework js_arrays = new Homework("JavaScript Arrays", "Learn about arrays in JavaScript and complete exercises", W7D1);
        homeworkRepository.save(js_arrays);

        //Content Day W7D2
        CourseNote js_objects = new CourseNote("JavaScript Objects", "Learn about objects in JavaScript and how to use them", W7D2);
        courseNoteRepository.save(js_objects);
        CourseNote js_events = new CourseNote("JavaScript Events", "Understand how to use events in JavaScript to create interactive web pages", W7D2);
        courseNoteRepository.save(js_events);
        Lab js_conditional_statements = new Lab("JavaScript Conditional Statements", "Practice using conditional statements in JavaScript", W7D2);
        labRepository.save(js_conditional_statements);

        //Content Day W7D3
        Lab js_loops = new Lab("JavaScript Loops", "Practice using loops in JavaScript", W7D3);
        labRepository.save(js_loops);
        CourseNote js_forms = new CourseNote("JavaScript and Forms", "Learn how to use JavaScript to process form data", W7D3);
        courseNoteRepository.save(js_forms);
        CourseNote ajax_with_js = new CourseNote("AJAX with JavaScript", "Understand how to use AJAX in JavaScript to dynamically update web pages", W7D3);
        courseNoteRepository.save(ajax_with_js);
        Homework js_debugging = new Homework("JavaScript Debugging", "Learn about common debugging techniques in JavaScript and complete exercises", W7D3);
        homeworkRepository.save(js_debugging);

        //Content Day W7D4
        CourseNote js_best_practices = new CourseNote("JavaScript Best Practices", "Learn about best practices in JavaScript programming", W7D4);
        courseNoteRepository.save(js_best_practices);
        Lab js_object_oriented_programming = new Lab("JavaScript Object-Oriented Programming", "Practice using OOP in JavaScript", W7D4);
        labRepository.save(js_object_oriented_programming);
        CourseNote js_and_jquery = new CourseNote("JavaScript and jQuery", "Learn how to use the jQuery library with JavaScript", W7D4);
        courseNoteRepository.save(js_and_jquery);

        //Content Day W7D5
        CourseNote javaScript_testing_with_jest = new CourseNote("JavaScript Testing with Jest", "This will be the content of what is programming", W7D5);
        courseNoteRepository.save(javaScript_testing_with_jest);
        Homework server_side_rendered = new Homework("Building Server-Side Rendered React Applications", "This will be the content of the Github Homework", W7D5);
        homeworkRepository.save(server_side_rendered);
        CourseNote w7d5_recap = new CourseNote("Weekly Recap - W6D5", "This will be the content of what is programming", W7D5);
        courseNoteRepository.save(w7d5_recap);


        // Content Day W8D1
        CourseNote react_components = new CourseNote("React Components", "Learn the basics of creating components in React", W8D1);
        courseNoteRepository.save(react_components);
        CourseNote react_props = new CourseNote("React Props and State", "Understand how to use props and state in React", W8D1);
        courseNoteRepository.save(react_props);
        CourseNote react_routing = new CourseNote("React Routing", "Learn how to add routing to your React app", W8D1);
        courseNoteRepository.save(react_routing);
        Lab react_lifecycle_methods = new Lab("React Lifecycle Methods", "Practice using React's lifecycle methods", W8D1);
        labRepository.save(react_lifecycle_methods);
        Homework react_hooks = new Homework("React Hooks", "Learn about hooks in React and complete exercises", W8D1);
        homeworkRepository.save(react_hooks);

        // Content Day W8D2
        CourseNote react_context_api = new CourseNote("React Context API", "Learn about the Context API in React and how to use it", W8D2);
        courseNoteRepository.save(react_context_api);
        CourseNote react_flux = new CourseNote("React and the Flux Architecture", "Understand how to use the Flux architecture in React", W8D2);
        courseNoteRepository.save(react_flux);
        Lab react_redux = new Lab("React and Redux", "Practice using Redux in React", W8D2);
        labRepository.save(react_redux);

        // Content Day W8D3
        Lab react_testing = new Lab("React Testing", "Practice testing in React", W8D3);
        labRepository.save(react_testing);
        CourseNote react_tooling = new CourseNote("React Tooling", "Learn about tools and packages used in React development", W8D3);
        courseNoteRepository.save(react_tooling);
        CourseNote react_performance = new CourseNote("React Performance", "Understand how to optimize the performance of your React app", W8D3);
        courseNoteRepository.save(react_performance);
        Homework react_server_side_rendering = new Homework("React Server-Side Rendering", "Learn about server-side rendering in React and complete exercises", W8D3);
        homeworkRepository.save(react_server_side_rendering);

        // Content Day W8D4
        CourseNote react_deployment = new CourseNote("React Deployment", "Learn about deployment options for React apps", W8D4);
        courseNoteRepository.save(react_deployment);
        Lab react_animations = new Lab("React Animations", "Practice creating animations in React", W8D4);
        labRepository.save(react_animations);
        CourseNote react_advanced_topics = new CourseNote("React Advanced Topics", "Learn about advanced topics in React development", W8D4);
        courseNoteRepository.save(react_advanced_topics);

        //Content Day W8D5
        CourseNote javaScript_debugging_techniques = new CourseNote("JavaScript Debugging Techniques", "This will be the content of what is programming", W8D5);
        courseNoteRepository.save(javaScript_debugging_techniques);
        Homework building_single_page = new Homework("Building Single Page Applications with React Router", "This will be the content of the Github Homework", W8D5);
        homeworkRepository.save(building_single_page);
        CourseNote w8d5_recap = new CourseNote("Weekly Recap - W6D5", "This will be the content of what is programming", W8D5);
        courseNoteRepository.save(w8d5_recap);


        //Content Day W9D1
        CourseNote advanced_js_concepts = new CourseNote("Advanced JavaScript Concepts", "Learn about advanced concepts in JavaScript programming", W9D1);
        courseNoteRepository.save(advanced_js_concepts);
        CourseNote react_basics = new CourseNote("React Basics", "Learn the basics of React and how to use it for building web applications", W9D1);
        courseNoteRepository.save(react_basics);
        CourseNote jsx_in_react = new CourseNote("JSX in React", "Understand how to use JSX to write components in React", W9D1);
        courseNoteRepository.save(jsx_in_react);
        Lab state_and_props = new Lab("State and Props in React", "Practice using state and props in React", W9D1);
        labRepository.save(state_and_props);
        Homework advanced_react_routing = new Homework("React Routing", "Learn about routing in React and complete exercises", W9D1);
        homeworkRepository.save(advanced_react_routing);

        //Content Day W9D2
        CourseNote react_forms = new CourseNote("React Forms", "Learn about forms in React and how to handle form submissions", W9D2);
        courseNoteRepository.save(react_forms);
        CourseNote custom_react_hooks = new CourseNote("React Hooks", "Understand how to use hooks in React for state management and side effects", W9D2);
        courseNoteRepository.save(custom_react_hooks);
        Lab higher_order_components = new Lab("Higher Order Components in React", "Practice using higher order components in React", W9D2);
        labRepository.save(higher_order_components);

        //Content Day W9D3
        Lab context_api = new Lab("Context API in React", "Practice using the Context API in React for data management", W9D3);
        labRepository.save(context_api);
        CourseNote advanced_js_patterns = new CourseNote("Advanced JavaScript Patterns", "Learn about advanced design patterns in JavaScript", W9D3);
        courseNoteRepository.save(advanced_js_patterns);
        CourseNote javaScript_modules_and_namespaces = new CourseNote("JavaScript Modules and Namespaces", "Understand how to optimize performance in React", W9D3);
        courseNoteRepository.save(javaScript_modules_and_namespaces);
        Homework react_state = new Homework("React State Management", "Learn about state management in React and complete exercises", W9D3);
        homeworkRepository.save(react_state);

        //Content Day W9D4
        CourseNote react_best_practices = new CourseNote("React Best Practices", "Learn about best practices in React programming", W9D4);
        ...
        Homework submit_js_project_briefs = new Homework("Submit JS Project Briefs", "This will be the content of the Github Homework", W9D5);
        homeworkRepository.save(submit_js_project_briefs);
        CourseNote w9d5_recap = new CourseNote("Weekly Recap - Week 9", "This will be the content of what is programming", W9D5);
